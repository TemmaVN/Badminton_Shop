...
const SERIAL_STATUS_CFG = {
  ...
  Reserved:  { color: "text-amber-600 dark:text-amber-400",     bg: "bg-amber-50 dark:bg-amber-500/15",     border: "border-amber-200 dark:border-amber-500/30",     dot: "bg-amber-400",  label: "Đang giữ" },
          ...
          <tbody className="divide-y divide-gray-50 dark:divide-slate-800">
            {loading ? (
              ...
              lowStockItems.map((item, idx) => {
                ...
                return (
                  <tr key={item.detailId ?? idx} className="hover:bg-gray-50 dark:hover:bg-slate-800/40 transition-colors">
                      ...
                      <div className="flex items-center gap-3">
                        {item.productImageUrl && (
                          <img
                            ...
                            alt=""
                            className="w-9 h-9 rounded-lg object-cover shrink-0 border border-gray-100 dark:border-slate-700"
        ...
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-gray-50 dark:divide-slate-800">
            {loading ? (
              ...
              serials.map((s, idx) => {
                const id = s.serialId ?? idx;
                const status = s.status ?? activeStatus;
                      ...
                      <div className="flex items-center gap-3">
                        {s.productImageUrl && (
                          <img
                            ...
                            alt=""
                            className="w-8 h-8 rounded-lg object-cover shrink-0 border border-gray-100 dark:border-slate-700"
                            onError={(e) => { e.target.style.display = "none"; }}
                          />
                        )}
                        <div>
