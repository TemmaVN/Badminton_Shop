...
const STATUSES = {
  ...
  9: { text: "Đang yêu cầu trả hàng/hoàn tiền", color: "bg-amber-100 dark:bg-amber-500/15 text-amber-700 dark:text-amber-400" },
  10:{ text: "Đã chấp thuận trả hàng/hoàn tiền", color: "bg-cyan-100 dark:bg-cyan-500/15 text-cyan-700 dark:text-cyan-400" },
  11:{ text: "Đã hoàn hàng/hoàn tiền", color: "bg-rose-100 dark:bg-rose-500/15 text-rose-700 dark:text-rose-400" },
};
      ...
      <div className="max-w-8xl mx-auto bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
                  ...
                  >
                    ...
                    <td className="p-4 text-center">
                      <button
                        ...
                        onClick={(e) => { e.stopPropagation(); handleOpenDetail(order.orderId); }}
                        className="p-2 hover:bg-blue-50 dark:hover:bg-blue-500/10 text-blue-500 dark:text-blue-400 rounded-lg disabled:opacity-50"
                      >
        ...
        <div className="p-4 border-t border-slate-100 dark:border-slate-700 flex items-center justify-between">
          <span className="text-sm text-slate-500 dark:text-slate-400">
            Trang <span className="font-semibold text-slate-700 dark:text-slate-200">{page}</span> / {pagination.totalPages || 1}
          </span>
          <div className="flex gap-2">
            <button
